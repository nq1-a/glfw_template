...
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.91.1 (ed61e7d7e 2025-11-07) (Arch Linux rust 1:1.91.1-2)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.91.1 (ed61e7d7e 2025-11-07) (Arch Linux rust 1:1.91.1-2)";
#[allow(clippy::needless_raw_string_hashes)]
