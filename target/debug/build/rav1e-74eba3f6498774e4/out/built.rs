...
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.92.0 (ded5c06cf 2025-12-08) (Arch Linux rust 1:1.92.0-1)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.92.0 (ded5c06cf 2025-12-08) (Arch Linux rust 1:1.92.0-1)";
#[allow(clippy::needless_raw_string_hashes)]
